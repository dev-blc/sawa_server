...
const sendRedirectHtml = (res, html) => {
...
const createApp = () => {
    ...
    app.get('/health', async (_req, res) => {
        ...
        try {
            const { cachePing } = await Promise.resolve().then(() => __importStar(require('./lib/cache')));
    ...
    app.get('/img/*', async (req, res) => {
        ...
        try {
            const { getObjectStream } = await Promise.resolve().then(() => __importStar(require('./lib/storage')));
    ...
    app.get('/share/community/:id', async (req, res) => {
        ...
        sendRedirectHtml(res, renderSharePage({
